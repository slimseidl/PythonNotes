...
if __name__ == "__main__":
    ...
    item_name = input("Please enter the name of a food to calculate calories for:\n")
    if item_name == 'Water' or item_name == 'water':
        ...
        amount_fat = float(input("Enter grams of fat:\n"))
        amount_carbs = float(input("Enter grams of carbohydrates:\n"))
