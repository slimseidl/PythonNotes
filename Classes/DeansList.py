...
class Course:
    ...
    # My code failed at first because I didn't have deans_list as a list and was returning values inside the loop
    def get_deans_list(self):
        deans_list = [] # Didnt have this 
        for name in self.roster:
            if name.get_gpa() >= 3.5:
                deans_list.append(name) # or this
                # Was using return name
            else:
                continue
        return deans_list
